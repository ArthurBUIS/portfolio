...
const DATA = {
  ...
  education: [
    { icon: "🧬",
      ...
      when: { fr: "Sept. 2026 à Août 2028 • Lyngby", en: "Sept. 2026 to Aug. 2028 • Lyngby" },
    ...
    { icon: "🏛️",
      ...
      desc: { fr: "Première université d'ingénieurs française, admission par concours national. Parcours mathématiques appliquées, informatique, biologie et intelligence artificielle. Cours suivis : machine et deep learning, vision par ordinateur, chaînes de Markov, statistiques, optimisation, traitement du signal, calcul parallèle, biologie moléculaire et cellulaire. GPA 3,82/4, CGPA 3,91/4.",
              en: "Top-ranked French engineering university, with admission through nationally competitive examinations. Track focused on applied mathematics, computer science, biology and artificial intelligence. Coursework: machine and deep learning, computer vision, Markov chains, statistics, optimisation, signal processing, parallel computing, molecular and cell biology. GPA 3.82/4, CGPA 3.91/4." },
  ...
  proProjects: [
    ...
    { icon: "🎖️",
      ...
      skills: { fr: ["Conception du programme de formation militaire initiale d'une section de plus de 30 recrues",
                ...
                en: ["Designed the initial military training programme for a platoon of 30+ recruits",
  ...
  outside: [
    { icon: "🥁", title: {fr:"Musique",en:"Music"},
      items: {fr:"Batteur rock/pop, expérience régulière de la scène et des concerts live. Vice-président de l'<a href=\"https://ado.binets.fr/\" target=\"_blank\" rel=\"noopener\">Atelier Des Ondes</a>, association qui organise les concerts et gère le son des événements de l'École Polytechnique.",
              en:"Rock/pop drummer with regular stage and live concert experience. Vice-president of the <a href=\"https://ado.binets.fr/\" target=\"_blank\" rel=\"noopener\">Atelier Des Ondes</a>, the association running concerts and live sound at École Polytechnique."} },
    { icon: "🏅", title: {fr:"Course à pied",en:"Running"},
      items: {fr:"Course en compétition, plus de 20 trails et courses urbaines au compteur (<a href=\"https://strava.app.link/0HlKfWqq85b\" target=\"_blank\" rel=\"noopener\">Strava</a>).",
              en:"Competitive running, with 20+ trail and urban races (<a href=\"https://strava.app.link/0HlKfWqq85b\" target=\"_blank\" rel=\"noopener\">Strava</a>)."} },
    { icon: "➗", title: {fr:"Mathématiques",en:"Mathematics"},
      items: {fr:"Deux fois lauréat du <a href=\"https://www.concours-archimede.com/\" target=\"_blank\" rel=\"noopener\">concours national Archimède</a> (plus de 1000 participants). Cours particuliers de mathématiques et d'informatique pour lycéens et préparationnaires.",
              en:"Two-time winner of the <a href=\"https://www.concours-archimede.com/\" target=\"_blank\" rel=\"noopener\">national Archimède competition</a> (1000+ participants). Private maths and computer science tutoring for high school and preparatory class students."} }
  ],
